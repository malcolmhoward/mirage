...
2. This creates your personal copy at `github.com/YOUR-USERNAME/mirage`
...
git remote add upstream https://github.com/ORIGINAL-OWNER/mirage.git
```
...
gh issue list --repo malcolmhoward/mirage
```

**Then create your branch with that issue number:**

```bash
git checkout -b feat/mirage/<issue#>-description
